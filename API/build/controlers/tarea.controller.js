...
// -------------------------------------------------------------------------------------------------- GET --------------------------------------------------------------------------------------------------
var formatearFecha = function formatearFecha(fechaOriginal) {
...
var getTareas = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          console.log(id_casa);
          _context3.next = 8;
          return connection.query("SELECT * FROM tareas WHERE id_casa = ?", id_casa);
        case 8:
          result = _context3.sent;
          // Mapear las tareas y obtener nombres de participantes
          tareasPromesas = result.map( /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tarea) {
              var correosParticipantes, nombresPromesas, nombresParticipantes;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    correosParticipantes = tarea.participantes.split(',');
                    nombresPromesas = correosParticipantes.map( /*#__PURE__*/function () {
                      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(participante) {
                        var connection, usuario, nombre;
                        return _regeneratorRuntime().wrap(function _callee$(_context) {
                          while (1) switch (_context.prev = _context.next) {
                            ...
                            case 5:
                              ...
                              nombre = usuario[0] ? usuario[0].nombre : 'Nombre no encontrado'; // Comprobar si usuario[0] existe
                              return _context.abrupt("return", nombre);
                            case 8:
                            case "end":
                  ...
                  case 4:
                    nombresParticipantes = _context2.sent;
                    ...
                    return _context2.abrupt("return", tarea);
                  case 9:
                  case "end":
          ...
          _context3.next = 12;
          return Promise.all(tareasPromesas);
        case 12:
  ...
  return function getTareas(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

//  #################################### VER TAREAS PENDIENTES ####################################
var getTareasPendientes = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var id_casa, connection, result, tareasPromesas, tareas;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          _context6.next = 7;
          return connection.query("SELECT * FROM tareas WHERE id_casa = ? and estado <> 'Completado'", id_casa);
        case 7:
          result = _context6.sent;
          // Mapear las tareas y obtener nombres de participantes
          tareasPromesas = result.map( /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(tarea) {
              var correosParticipantes, nombresPromesas, nombresParticipantes;
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    correosParticipantes = tarea.participantes.split(',');
                    nombresPromesas = correosParticipantes.map( /*#__PURE__*/function () {
                      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(participante) {
                        var connection, usuario, nombre;
                        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                          while (1) switch (_context4.prev = _context4.next) {
                            ...
                            case 5:
                              ...
                              nombre = usuario[0] ? usuario[0].nombre : 'Nombre no encontrado'; // Comprobar si usuario[0] existe
                              return _context4.abrupt("return", nombre);
                            case 8:
                            case "end":
                    ...
                    return Promise.all(nombresPromesas);
                  case 4:
                    nombresParticipantes = _context5.sent;
                    // Actualizar la tarea con los nombres de los participantes
                    tarea.participantes = nombresParticipantes;
                    if (!tarea.fecha_completada) {
                      tarea.fecha_completada = "Debes hacerla";
                    ...
                    tarea.fecha_creacion = formatearFecha(tarea.fecha_creacion);
                    return _context5.abrupt("return", tarea);
                  case 9:
                  case "end":
  ...
  return function getTareasPendientes(_x5, _x6) {
    return _ref4.apply(this, arguments);
  };
}();

//  #################################### VER TAREAS COMPLETADAS ####################################
var getTareasCompletadas = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 7:
          ...
          // Mapear las tareas y obtener nombres de participantes
          tareasPromesas = result.map( /*#__PURE__*/function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(tarea) {
              var correosParticipantes, nombresPromesas, nombresParticipantes;
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  case 0:
                    correosParticipantes = tarea.participantes.split(',');
                    nombresPromesas = correosParticipantes.map( /*#__PURE__*/function () {
                      var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(participante) {
                        var connection, usuario, nombre;
                        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                          while (1) switch (_context7.prev = _context7.next) {
                            ...
                            case 5:
                              ...
                              nombre = usuario[0] ? usuario[0].nombre : 'Nombre no encontrado'; // Comprobar si usuario[0] existe
                              return _context7.abrupt("return", nombre);
                            case 8:
                            case "end":
                    ...
                    return Promise.all(nombresPromesas);
                  case 4:
                    nombresParticipantes = _context8.sent;
                    // Actualizar la tarea con los nombres de los participantes
                    tarea.participantes = nombresParticipantes;
                    if (!tarea.fecha_completada) {
                      tarea.fecha_completada = "Debes hacerla";
                    ...
                    tarea.fecha_creacion = formatearFecha(tarea.fecha_creacion);
                    return _context8.abrupt("return", tarea);
                  case 9:
                  case "end":
  ...
  return function getTareasCompletadas(_x9, _x10) {
    return _ref7.apply(this, arguments);
  };
}();

//  #################################### VER TAREA POR ID ####################################
var getTareaId = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 4:
          ...
          _context10.next = 7;
          return connection.query("SELECT * FROM tareas WHERE idtareas = ?", id);
        case 7:
  ...
  return function getTareaId(_x13, _x14) {
...
//  #################################### AÑADIR NUEVA TAREA ####################################
var addTarea = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(req, res) {
    var _req$body, nombre, descripcion, participantes, estado, id_casa, idtareas, message, correosParticipantes, malCorreo, tarea, connection, nuevaTarea;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          //try {
          //  Guardo los atributos del usuario que me envia la peticion (el id no se pone porque se autoincrementa)
          _req$body = req.body, nombre = _req$body.nombre, descripcion = _req$body.descripcion, participantes = _req$body.participantes, estado = _req$body.estado, id_casa = _req$body.id_casa;
          _context12.next = 3;
          return _generarIdAleatorio.methods.generateEncryptedId();
        case 3:
          idtareas = _context12.sent;
        ...
        case 7:
          ...
          return Promise.all(correosParticipantes.map( /*#__PURE__*/function () {
            var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(participante) {
        ...
        case 16:
          ...
          _context12.next = 19;
          return connection.query("INSERT INTO tareas SET ?", tarea);
        case 19:
          nuevaTarea = _context12.sent;
          //  Devuelve un JSON con los datos obtenidos
          res.json({
  ...
  return function addTarea(_x15, _x16) {
...
//  #################################### ACTUALUZAR TAREA ####################################
var updateTarea = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(req, res) {
    var id, _req$body2, idtareas, nombre, descripcion, participantes, estado, fecha_creacion, fecha_completada, connection, tarea, result;
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          ...
          _req$body2 = req.body, idtareas = _req$body2.idtareas, nombre = _req$body2.nombre, descripcion = _req$body2.descripcion, participantes = _req$body2.participantes, estado = _req$body2.estado, fecha_creacion = _req$body2.fecha_creacion, fecha_completada = _req$body2.fecha_completada; //  Comprueba que ninguno de los campos este vacio 
        ...
        case 6:
          ...
          _context13.next = 10;
          return connection.query("UPDATE tareas SET ? WHERE idtareas = ?", [tarea, id]);
        case 10:
  ...
  return function updateTarea(_x18, _x19) {
...
var completarTarea = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 3:
          ...
          _context14.next = 6;
          return connection.query("UPDATE tareas SET estado = 'Completado' WHERE idtareas = ?", id);
        case 6:
  ...
  return function completarTarea(_x20, _x21) {
...
//  #################################### ELIMINAR TAREAS ####################################
var deleteTarea = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        ...
        case 4:
          ...
          _context15.next = 7;
          return connection.query("DELETE FROM tareas WHERE idtareas = ?", id);
        case 7:
  ...
  return function deleteTarea(_x22, _x23) {
...
var methods = exports.methods = {
  getTareas: getTareas,
  getTareaId: getTareaId,
  addTarea: addTarea,
  updateTarea: updateTarea,
  deleteTarea: deleteTarea,
  getTareasPendientes: getTareasPendientes,
  getTareasCompletadas: getTareasCompletadas,
