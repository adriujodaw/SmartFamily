...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var encryptPassword, uid, _req$body, nombre, sexo, correo, password, telefono, fecha_nacimiento, apellidos, tipo, message, family_points, usuario, token, connection, userFound, userCookie;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          console.log(req.body);
          //  Funcion para encriptar la contraseña
          encryptPassword = /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(password) {
        ...
        case 4:
          ...
          _req$body = req.body, nombre = _req$body.nombre, sexo = _req$body.sexo, correo = _req$body.correo, password = _req$body.password, telefono = _req$body.telefono, fecha_nacimiento = _req$body.fecha_nacimiento, apellidos = _req$body.apellidos, tipo = _req$body.tipo; //Comprueba que ninguno de los campos este vacio
        ...
        case 14:
          ...
          family_points = 0; //  Creo un objeto usuario con los atributos del usuario
          usuario = {
            uid: uid,
            nombre: nombre,
            sexo: sexo,
        ...
        case 21:
          ...
          _context2.next = 24;
          return connection.query("INSERT INTO usuarios set ?", usuario);
        case 24:
          _context2.next = 26;
...
var signIn = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var comparePassword, _req$body2, correo, password, connection, userFound, idRoles, roles, _iterator, _step, id, usuario, message, matchPassword, token, userCookie;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          //  Funcion para comparar la contraseña con bcrypt
          comparePassword = /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(passwordLogin, passwordDB) {
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return _bcryptjs["default"].compare(passwordLogin, passwordDB);
                  case 2:
            ...
            return function comparePassword(_x7, _x8) {
              return _ref4.apply(this, arguments);
            };
          }(); //  Guardo en la variable correo el correo que se envía en el body de la peticion
          _req$body2 = req.body, correo = _req$body2.correo, password = _req$body2.password;
          console.log(req.body);
          if (!(!correo || !password)) {
            _context4.next = 5;
            break;
        ...
        case 13:
          ...
          idRoles = userFound[0].tipo.split(',');
          roles = [];
          _iterator = _createForOfIteratorHelper(idRoles);
          _context4.prev = 17;
          _iterator.s();
        case 19:
          ...
          id = _step.value;
          _context4.next = 23;
          return connection.query("SELECT rol from roles WHERE id = ?", id);
        case 23:
        ...
        case 41:
          _context4.next = 43;
          return comparePassword(req.body.password, userFound[0].password);
        case 43:
